...
namespace GmailAPI.APIHelper
{
    public static class GmailAPIHelper
    {
        ...
        public static GmailService GetService()
        {
            ...
            using (FileStream stream = new FileStream(Convert.ToString(System.Configuration.ConfigurationManager.AppSettings["ClientInfo"]),
                FileMode.Open, FileAccess.Read))
            {
                String FolderPath = Convert.ToString(System.Configuration.ConfigurationManager.AppSettings["CredentialsInfo"]);
